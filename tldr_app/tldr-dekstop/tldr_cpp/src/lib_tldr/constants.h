...
#define EMBEDDING_PROCESSING_MULTI_THREADED 1
#define EMBEDDING_PROCESSING_SINGLE_THREADED 2
#define EMBEDDING_PROCESSING EMBEDDING_PROCESSING_SINGLE_THREADED
...
#define EMBEDDING_MIN_CONTEXTS (1)
