...
namespace tldr {
    ...
    bool PostgresDatabase::saveDocumentMetadata(
        ...
        try {
            ...
            // Create copies of all parameters to ensure they stay in scope
            ...
            if (result.empty()) {
                ...
                insertParams.append(titleCopy.empty() ? nullptr : titleCopy);
                insertParams.append(authorCopy.empty() ? nullptr : authorCopy);
                insertParams.append(subjectCopy.empty() ? nullptr : subjectCopy);
                insertParams.append(keywordsCopy.empty() ? nullptr : keywordsCopy);
                insertParams.append(creatorCopy.empty() ? nullptr : creatorCopy);
                insertParams.append(producerCopy.empty() ? nullptr : producerCopy);
                ...
                // Add optional string fields
                updateParams.append(titleCopy.empty() ? nullptr : titleCopy);
                updateParams.append(authorCopy.empty() ? nullptr : authorCopy);
                updateParams.append(subjectCopy.empty() ? nullptr : subjectCopy);
                updateParams.append(keywordsCopy.empty() ? nullptr : keywordsCopy);
                updateParams.append(creatorCopy.empty() ? nullptr : creatorCopy);
                updateParams.append(producerCopy.empty() ? nullptr : producerCopy);
